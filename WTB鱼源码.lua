...
local Window = WindUI:CreateWindow({
  Title = "WORKERS' TRANSFORMATIONAL BLOC丨FISCH",
...
local HeroDialog = Window:Dialog({
  Title = "请选择你的英雄",
  Content = "通用",
  Buttons = {
    {
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/BINjiaobzx6/BINjiao/main/XK.TXT"))()
    ...
    },
    {
      ...
      Callback = function()
        ...
        loadstring(game:HttpGet([[https://raw.githubusercontent.com/coo-hsuhhw55/4414126/refs/heads/main/Protected_9257423712017012.lua]]))()
      end,
    }
  },
})
