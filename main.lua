...
紫罗兰色={
Name="紫罗兰色",
Accent = Color3.fromHex"#6d28d9",      -- 主色调
    Dialog = Color3.fromHex"#3c1361",     -- 对话框
    Outline = Color3.fromHex"#ddd6fe",    -- 轮廓
    Text = Color3.fromHex"#faf5ff",       -- 文字
    Placeholder = Color3.fromHex"#8f7ee0", -- 占位符
    Background = Color3.fromHex"#1e0a3e",  -- 背景
    Button = Color3.fromHex"#7c3aed",     -- 按钮
    Icon = Color3.fromHex"#8b5cf6",       -- 图标
},
...
ac("UIGradient",{
Color=ColorSequence.new(Color3.fromHex"4169E1", Color3.fromHex"00CED1")
})
}),
aj,
ak,
...
StrokeThickness=ap.StrokeThickness or 3,
Color=ap.Color
...
Title="YirdeX脚本中心",
Content="希望你下一次还能使用YirdeX脚本中心，拜拜👋",
Buttons={
{
Title="取消",
